...
const service = (() => {
    ...
    function addInvitation(invitedUserEmail, eventId, eventTitle, createdByUserId, createdByUserEmail, createdByUserName, eventDate, eventDetails = {}) {
        ...
        console.log(`[DEBUG] Invitation added for ${userKey}:`, invitation);
        console.log(`[DEBUG] All invitations for ${userKey}:`, stateLocal.invitationsByUser[userKey]);
        setState(stateLocal);
    ...
    function getCurrentUserInvitations() {
        const userKey = getUserKey();
        const invitations = userKey ? getInvitationsForUser(userKey) : [];
        console.log(`[DEBUG] getCurrentUserInvitations for ${userKey}:`, invitations);
        return invitations;
    }
